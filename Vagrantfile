...
Vagrant.configure(2) do |config|
  ...
  config.vm.define 'koto-build', autostart: false do |gitian|
...
#    gitian.vm.synced_folder "./koto-binaries", "/home/vagrant/koto-binaries", create: true
    gitian.vm.post_up_message = "Koto deterministic build environment started."
  end
